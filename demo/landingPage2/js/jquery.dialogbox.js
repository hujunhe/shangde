 ...
 ;(function($,window,document){
 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
 				dialogHTML[0] = '<section class="dialog-box" onclick="NTKF.im_openInPageChat()"><div class="dialog-box-container"><div class="dialog-box-content"></div>';			
 			}else{
 				if(!hasClose){
					dialogHTML[0] = '<section class="dialog-box" onclick="NTKF.im_openInPageChat()"><div class="dialog-box-container"><div class="dialog-box-title"><h3>'+ title + '</h3></div><div class="dialog-box-content"></div>';
 				}else{					
 					dialogHTML[0] = '<section class="dialog-box" onclick="NTKF.im_openInPageChat()"><div class="dialog-box-container"><div class="dialog-box-title"><h3>'+ title + '</h3><span class="dialog-box-close">×</span></div><div class="dialog-box-content"></div>';
 				}
 			}
 			...
 			if(!hasBtn){
 				...
 				if(confirmValue && cancelValue){
 					dialogHTML[1] = '<div class="dialog-btn" onclick="NTKF.im_openInPageChat()"><span class="dialog-btn-cancel">' + cancelValue + '</span><span class="dialog-btn-confirm">' + confirmValue + '</span></div></div></section>';
 				}else if(cancelValue){
 					dialogHTML[1] = '<div class="dialog-btn" onclick="NTKF.im_openInPageChat()"><span class="dialog-btn-cancel">' + cancelValue + '</span></div></div></section>';
 				}else if(confirmValue){
 					dialogHTML[1] = '<div class="dialog-btn" onclick="NTKF.im_openInPageChat()"><span class="dialog-btn-confirm">' + confirmValue + '</span></div></div></section>';
 				}else{
 					dialogHTML[1] = '<div class="dialog-btn" onclick="NTKF.im_openInPageChat()"><span class="dialog-btn-cancel">取消</span><span class="dialog-btn-confirm">确定</span></div></div></section>';
 				}
 			}
