					...
					if(activePage){
						...
						if(Math.abs(moveDistanceY) > Math.abs(moveDistanceX) && Math.abs(moveDistanceY) > 100){
							...
							if ($(activePage).index() == 0) {
							    ...
							    $("body").css("background-color", "#9f8b84");
							    $("#telTip").css("color", "#fff");
							} else if ($(activePage).index() == 3) {
							    $("body").css("background-color", "#849f95");
							    $("#telTip").css("color", "#fff");
							} else if ($(activePage).index() == 4) {
							    $("body").css("background-color", "#9e8a83");
							    $("#telTip").css("color", "#fff");
							} else if ($(activePage).index() == 5) {
							    $("body").css("background-color", "#fd5c25");
							    $("#telTip").css("color", "#fff");
							} else if ($(activePage).index() == 5) {
							    $("body").css("background-color", "#656ebc");
							    $("#telTip").css("color", "#fff");

							} else if ($(activePage).index() == 6) {
							    $("body").css("background-color", "#bad052");
							    $("#telTip").css("color", "#fff");
							} else if ($(activePage).index() == 7) {
							    $("body").css("background-color", "#a777ad");
							    $("#telTip").css("color", "#fff");
...
$(function(){
	...
	$(".u-globalAudio").on("click",function(){
		if($(this).hasClass("z-play")){
				...
				$(this).removeClass("z-pause").addClass("z-play");
				_play()
			}
		})
