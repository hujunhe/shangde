...
<head>
	...
	<link rel="shortcut icon" href="http://www.sunlands.com/images/favicon.ico" type="image/x-icon">
	...
	<input type="hidden" name="basePath" value="http://www.sunlands.com" id="basePath"/>
	<link rel="stylesheet" type="text/css" href="http://www.sunlands.com/css/share/nav.css">
	<link rel="stylesheet" type="text/css" href="http://www.sunlands.com/css/login.css">
	<script type="text/javascript" src="http://www.sunlands.com/js/jquery.min.js"></script>
	<script type="text/javascript" src="http://www.sunlands.com/js/jquery.include.js"></script>
	<script src="http://www.sunlands.com/js/jquery.cookie.js" type="text/javascript"></script>
	<script type="text/javascript" src="http://www.sunlands.com/js/login.js"></script>
	<script type="text/javascript">
	   var basePath="http://www.sunlands.com";
	   var sdObj={
			  open:function(href){
...
<div class="wrap_nav son_demo">
		<div class="nav_cen son_cen" id="header_nav">
			...
			<ul class="nav_select son_select">
				...
				<li>
					<a href="http://www.sunlands.com/region.htm" class="hov_goal">切换地区</a>
				</li>
			</ul>
			<ul class="nav_secen pad">
				<li><a href="http://www.sunlands.com/index.htm">首页</a></li>
				<li ><a href="http://www.sunlands.com/category/indexWebCategory.htm" id="allcourseNav">全部课程</a></li>
				<li><a href="http://www.sunlands.com/tiku/indexWebTiku.htm">免费题库</a></li>
				<li><a href="http://www.sunlands.com/trial/indexWebTrial.htm">免费体验区</a></li>
				
				<li><a href="http://yi.sunlands.com" target="_blank">个人中心</a></li>
				<li><a href="http://www.sunlands.com/sanlandsCulture/sanlandsCulture.htm">尚德文化</a></li>
			</ul>
	 ...
	 <input id="userParam"  type="hidden" value="38608146379"/>
	
	  
<!-- 注册登录 -->
<div class="shade" id="shade"></div>
<div class="user_log" id="user_log">
	<div class="del_ben" id="close">
		<img src="http://www.sunlands.com/img/index-Img/del.png">
	</div>
	<form action="" id="registerForm">
		...
		<div class="new_enroll">
			...
			<div class="phone_wrap clearfix">
				<p class="no-show" id="error_register">
					<span><img src="http://www.sunlands.com/img/index-Img/pic31.gif"></span>请输入手机号
				</p>
				<input type="text" name="mobile" value="" id="mobile"
					placeholder="手机号" class="on_pche" />
			</div>
			<div class="phone_wrap mar_mix">
				<div class="cover" id="cover"></div>
				<input type="password" nama="password" value="" id="password"
					placeholder="密&nbsp;&nbsp;码" />
			</div>
			<div class="verify_wrap" id="verify_wrap">
				<a href="javascript:;"
					style="font-size: 12px; line-height: 40px; color: #fff;">获取验证码</a>
				<div class="input_wr" id="input_wr">
					<input type="text" name="mobile_code" value="" id="mobile_code"
						placeholder="验证码" />
				</div>
			</div>
			<div id="voiceVcode"
				style="float: right; width: 242px; line-height: 26px; margin-right: 25px; color: #666666; display: none;">
				如果长时间未收到，请点击这里<a href="javascript:void(0);" style="color: #2a75bb;">获取语音验证</a>
			</div>
			<div class="free_btn" style="clear: both;" id="regisger_submit"
				onclick="_hmt.push(['_trackEvent', 'register_login', 'register', '','']);">免费注册</div>
		</div>
	</form>
	<form action="" id="loginForm">
		<input type="hidden" name="casUrl" id="casUrl"
			value='http://passport.sunlands.com/cas' /> <input
			type="hidden" name="service" id="service" value="http://www.sunlands.com/error.htm" /> <input
			type="hidden" name="auto" id="auto" value="true" />
		<div class="new_enroll old_user">
			<h1>老用户登录</h1>
			<div class="phone_wrap clearfix">
				<p class="deng_show" id="error_login">
					<span><img src="http://www.sunlands.com/img/index-Img/pic31.gif"></span>请使用手机号登录
				</p>
				<input type="text" name="username" value="" id="username"
					placeholder="手机号" class="tw_pche"
					style="width: 295px; padding-left: 10px;" />
			</div>
			<div class="phone_wrap mar_mix">
				<input type="password" name="password" value="" id="password"
					placeholder="密&nbsp;&nbsp;码" class="padd-no"
					style="width: 295px; padding-left: 10px;" />
			</div>
			<h4 style="float: right; margin-top: 42px; margin-right: 6px;">
				<a href="http://passport.sunlands.com/showForgetPage.action"
					style="color: #2A75BB" target="_blank">忘记密码?</a>
			</h4>
			<div class="immediately_btn" id="login_submit"
				onclick="_hmt.push(['_trackEvent', 'register_login', 'login', '','']);">立即登录</div>
			<h5
				style="color: #2A75BB; display: inline; position: absolute; left: 34px; top: 219px;">
				<input type="checkbox" style="margin-right: 5px;" checked="checked"
					id="che" />记住密码
			</h5>
		</div>
	</form>
	<form action="" id="cas_login">
		<input type="hidden" name="casLoginUrl" id="casLoginUrl" value='http://passport.sunlands.com/cas'/>
		<input type="hidden" name="service" id="casLoginService" value="http://www.sunlands.com/error.htm" />
		<input type="hidden" name="isgw" id="isgw" value="true"/>
	</form>
</div>
...
<div class="baocuo">
   <a href="http://www.sunlands.com" class="shouye"></a>
...
<link rel="stylesheet" type="text/css"
	href="http://www.sunlands.com/css/share/footer.css">
<!-- footer 开始 -->
<div class="wrap_foo">
